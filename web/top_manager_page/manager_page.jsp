...
<html>
  ...
  <div >
      ...
      <div class="tag_switch">
          ...
          <a class="manager" href="top_manager_page/manager_page.jsp"><div class="tag_manager_selected">管理主界面</div></a>
          ...
          <a class="manager" href="top_manager_page/manager_data.jsp"><div class="tag_manager">科学搭配管理</div></a>
